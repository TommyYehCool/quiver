...
> = {
  "zh-TW": {
    title: "策略偏好",
    subtitle:
      "選一個風險偏好,Quiver 會用對應的方式切分梯隊 (ladder)、選掛單天數。隨時可換,下一次新存入或自動續借就會生效。",
    saved: "已儲存",
    failed: "儲存失敗",
    presets: {
      conservative: {
        label: "保守",
        blurb: "8 成資金壓在最快成交的基礎利率,鎖定天數最長 7 天 — 想隨時取回的人。",
        bullets: [
          "梯隊配置:80% 基礎 / 15% 小波 / 5% 中波",
          "鎖定天數:最長 7 天(高利率也不長鎖)",
          "犧牲爆炸性 spike 收益,換流動性",
        ],
      },
      balanced: {
        label: "平衡",
        blurb: "Quiver 預設策略 — 6 成基礎成交快、3.4 成捕捉 spike,鎖定 2 / 7 / 14 / 30 天分層。",
        bullets: [
          "梯隊配置:60 / 20 / 10 / 7 / 3 (五階)",
      ...
      aggressive: {
        label: "進取",
        blurb: "更多資金壓在中高利率梯隊,極端 spike 鎖到 60 天 — 想極大化波動利潤。",
        bullets: [
          "梯隊配置:40 / 25 / 15 / 12 / 8 (重押 spike)",
          "鎖定天數:最長 60 天(20%+ APR 鎖長)",
          "資金可能較長時間無法取回,但 spike 抓得更滿",
        ],
      },
    },
  },
