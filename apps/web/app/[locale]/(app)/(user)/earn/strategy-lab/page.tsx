...
const STRINGS: Record<Locale, {
  ...
  "zh-TW": {
    back: "返回 Earn",
    title: "策略實驗室",
    subtitle: "試算 F-5a-3.10 智慧選擇器在不同 preset / 金額下的決策。預覽不會實際下單。",
    needSetupTitle: "尚未連接 Bitfinex",
    needSetupDesc: "先到 Earn 完成 Bitfinex 連接,才能用實際資金做策略試算。",
    goSetup: "前往設定",
    about: {
      title: "這個頁面在做什麼?",
      body: "F-5a-3.10 智慧選擇器會在 auto-lend 觸發時,根據即時市場信號(各期間中位數利率 + 30 分鐘成交量 + FRR)自動算出最佳的 (利率, 期間, 金額) 組合,而不是用單一固定的 FRR 利率掛單。這個頁面是它的 dry-run 預覽 — 你可以切 preset / 改金額,看它在當下會怎麼決定。沒有任何實際下單行為。",
    },
  },
  en: {
    back: "Back to Earn",
    title: "Strategy lab",
    subtitle: "Dry-run the F-5a-3.10 smart selector across presets and amounts. Preview only — no orders submitted.",
    ...
    about: {
      ...
      body: "When auto-lend fires, the F-5a-3.10 smart selector reads live market signals (per-period median rate + 30-min volume + FRR) and computes the best (rate, period, amount) tranches — instead of posting at a single FRR rate. This page is its dry-run preview: change preset or amount to see what it would decide right now. Nothing is actually submitted.",
    },
  },
  ja: {
    back: "Earn に戻る",
    title: "戦略ラボ",
    subtitle: "F-5a-3.10 スマートセレクターを preset / 金額別にドライラン試算。プレビューのみ、注文は出ません。",
    needSetupTitle: "Bitfinex 未接続",
    needSetupDesc: "Earn ページで Bitfinex 接続を完了してから、実資金での戦略試算をお試しください。",
    goSetup: "設定へ",
    about: {
      title: "このページの目的",
      body: "auto-lend 実行時、F-5a-3.10 スマートセレクターはリアルタイムの市場シグナル(期間別中央値利率 + 30 分間出来高 + FRR)から最適な (利率、期間、金額) の組み合わせを自動算出します(単一 FRR 利率での掲示ではなく)。このページはそのドライランプレビュー — preset・金額を変えて現時点での判断を確認できます。実際の発注は行われません。",
    },
  },
};
